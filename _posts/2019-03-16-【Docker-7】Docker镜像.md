...
6. 尽量选择官方提供的镜像版本来作为基础镜像，减小镜像的体积
...
15. 不要在构建中升级版本，如果更新时试图修改容器的内容，更新可能会失败，还可能产生不一致的镜像
16. 使用指令组合，比如 apt-get update 应该和apt-get install 结合
...
21. WORKDIR 的路径始终使用绝对路径可以保证指令的准确和可靠，使用 WORKDIR 来替代 RUN cd ... && do-something 这样难以维护的指令
